...
VALUES(1,1,'testtext'),(2,1,'testtext2'),(3,1,'testtext3'),(4,2,'イカ'),(5,2,'タコ'),(6,3,'東京'),(7,3,'京都');

INSERT IGNORE INTO `questions` (`question_id`,`title`,`question_detail`,`limit_time`,`answer_fin`,`project_id`)
VALUES
(1,'ques2','test','2019-06-20 12:20',0,1),
(2,'ques2','test','2019-06-20 12:20',1,2),
(3,'ques2','test','2019-06-20 12:20',1,3),
(4,'ques2','testtest','2019-06-20 12:20',0,1);
